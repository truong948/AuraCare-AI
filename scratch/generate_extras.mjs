...
const scriptContent = `import type { MockProduct } from "./catalog";
...
fs.writeFileSync(path.join(process.cwd(), "lib", "mock-data", "catalog-extras.ts"), scriptContent, "utf-8");
console.log("Written catalog-extras.ts");
