...
import { BrainCircuit, BookOpenText, Droplets, ReceiptText, ScanLine, Settings, Sparkles, SquareKanban, UserCog, MessageSquare } from "lucide-react";
...
const navigationItems = [
  ...
  { label: "Đánh giá", href: "/dashboard/feedback", icon: MessageSquare, adminOnly: true },
  { label: "Tư vấn AI", href: "/dashboard/consultations", icon: BrainCircuit, adminOnly: true },
...
export function DashboardLogo() {
  return (
    <Link href="/dashboard" className="flex items-center gap-3">
      <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 via-blue-500 to-sky-400 text-white shadow-lg shadow-blue-500/20">
        ...
        return (
          <Button
            ...
            className={cn(
              ...
              isActive
                ? "bg-[#0b57c5] text-white hover:bg-[#0b57c5]/90"
...
export function DashboardSidebar({ role }: DashboardSidebarProps) {
  return (
    <aside className="hidden h-screen w-72 shrink-0 border-r border-slate-200/70 bg-[#f0f4fa] px-5 py-6 lg:flex lg:flex-col">
      <DashboardLogo />
      ...
      <div className="mt-auto rounded-3xl border border-white/80 bg-white/90 p-4 shadow-sm shadow-blue-950/5">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#0b57c5] text-white">
